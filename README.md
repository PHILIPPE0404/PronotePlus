...
L'URL Pronote configurée dans app.py.

Le connecteur ent_ecollege78.

La version installée de pronotepy.

Les éventuelles restrictions réseau de l'hébergeur.
...
Les restrictions réseau de l'hébergeur.
